...
### 高度な検索
icVault に登録されているファイルが増えると一覧で見つけることが難しくなっていきます。
[高度な検索] によりファイルを早く探しだし、データを取得することができます。<br>

1．[検索ワード]欄 にキーワードを入力し、[検索] をクリックします。<br>
...
<tr>
<th>Vault から追加</th>
<td>icVault に登録され、ファイル一覧に表示されるファイルから選択します。
</td>
</tr>
<tr>
<th>削除</th>
...
<div class="note">
バージョンを削除(ごみ箱)実行後もデータは icVault内 に残っています。<br>
icVault から削除する場合は、カテゴリのごみ箱を選択し [ごみ箱からファイル削除] を実行してください。
</div><br />
...
<div class="note">
ファイル削除(ごみ箱)実行後もデータは icVault内 に残っています。<br>
icVault から削除する場合は、カテゴリのごみ箱を選択し [ごみ箱からファイル削除] を実行してください。
</div><br />


### BOM を出力
選択したファイルの BOM情報 をエクセルに出力します。
...
<td>チェック有り：icVault に登録されている全バージョンに適用されます。<br>
...
<div class="note">
設定はユーザが使用する IRONCAD毎 に実施してください。
</div><br />
...
<table>
<tr>
<th>ファイル一覧を IRONCAD のウィンドウより前面に表示する</th>
<td>チェック有り：IRONCAD画面 と重なっている時に常にファイル一覧が前面に表示されます。<br>
チェック無し：IRONCAD画面 と重なっている時に IRONCAD の操作時は背面に移動します。。
</td>
</tr>
<tr>
<th>ウィンドウサイズ設定</th>
...
<td>プレビュー画面をクリックした際に起動するicWebViewer　のバージョンを設定します。<br> 
</td>
</tr>
</table>
