...
〔3〕新規インストールにチェックを入れ、[次へ] をクリックします。

![icVSDB3](./img/Install_013.png)
...
〔5〕設定の確認メッセージが表示されます。[デフォルト設定] をクリックします。<br>
